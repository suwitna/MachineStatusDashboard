...
* **`Plant`** รหัสตึก/อาคาร เช่น `F1`, `F2` (ใช้สำหรับคัดกรองข้อมูลเพื่อแสดงข้อมูลตาม Plant)
...
* **`LeftPct`** ระยะห่างของมุมซ้ายบนสุดของกรอบป้ายแสดงข้อมูล วัดจากขอบซ้ายสุดของรูปภาพผังโรงงาน "factory_floor_{Plant}.png"
* **`TopPct`** ระยะห่างของมุมซ้ายบนสุดของกรอบป้ายแสดงข้อมูล วัดจากขอบบนสุดของรูปภาพผังโรงงาน "factory_floor_{Plant}.png"
* **`WidthPct`** ความกว้างรวมของกรอบป้ายแสดงข้อมูล (คำนวณคลุมพื้นที่ทั้งตัวป้ายและเส้นชี้ทั้งหมด)
* **`HeightPct`** ความสูงรวมของกรอบป้ายแสดงข้อมูล
...
```
### STEP 2: จัดการระบบรูปภาพ 
วางไฟล์รูปภาพฟอร์แมต "factory_floor_{Plant}.png"  
